...
export default function BlogCard({ blog }: BlogCardProps) {
  return (
    <Link href={`/blogs/${blog.id}`}>
      <article className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-5 shadow-sm cursor-pointer h-full flex flex-col">
        <div className="flex-1">
          <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2 line-clamp-2 leading-snug">
            {blog.title}
          </h2>
